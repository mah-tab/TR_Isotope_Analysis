...
This version is for:
  Tree Ring Width / TRW climate correlations
...
Updated for TRW climate correlation summaries
"""
...
# Main TRW summary text folder
BASE_INPUT_DIR = (
    r"E:\FAU master\Master Thesis\Correlation\Correlation outputs"
    r"\Narrow missing removed\TRW climate correlation\All_summary_texts"
)

# New Baft summary text folder
# Using exactly the Baft_new path you gave
BAFT_NEW_DIR = (
    r"E:\FAU master\Master Thesis\Correlation\Correlation outputs"
    r"\Narrow missing removed\d18 climate correlation\All_summary_texts\Baft_new"
)

# Output folder for TRW extracted Excel files
OUTPUT_DIR = (
    r"E:\FAU master\Master Thesis\Correlation\Correlation outputs"
...
def collect_summary_files():
    ...
    # ----------------------------
    # Old / main TRW station summaries
    # ----------------------------
    old_paths = sorted(
    ...
    for path in old_paths:
        ...
        # Ignore old Baft in the base TRW folder, same logic as previous script
...
def write_old_style_param_excels(df):
    ...
    for variable in variables:
        ...
        output_path = os.path.join(
            OUTPUT_DIR,
            f"TRW_summary_correlations_{variable}.xlsx"
        )
...
def main():
    ...
    csv_path = os.path.join(
        OUTPUT_DIR,
        "TRW_summary_correlations_all_climate_params_long.csv"
    )
    ...
    print("\nDone.")
    print(f"All TRW outputs saved in:\n{OUTPUT_DIR}")
